...
dif_Eu_Mx_Identical <- abs(Eu_Mx_Identical$`Spanish (European).x` - Eu_Mx_Identical$`Spanish (Mexican).x`)
dif_Eu_Mx_NonIdentical <- abs(Eu_Mx_NonIdentical$`Spanish (European).x` - Eu_Mx_NonIdentical$`Spanish (Mexican).x`)

dif_Eu_Ar_Identical <- abs(Eu_Ar_Identical$`Spanish (European).x`- Eu_Ar_Identical$`Spanish (Argentinian).x`)
dif_Eu_Ar_NonIdentical <- abs(Eu_Ar_NonIdentical$`Spanish (European).x` - Eu_Ar_NonIdentical$`Spanish (Argentinian).x`)

dif_Eu_Pr_Identical <- abs(Eu_Pr_Identical$`Spanish (European).x` - Eu_Pr_Identical$`Spanish (Peruvian).x`)
dif_Eu_Pr_NonIdentical <- abs(Eu_Pr_NonIdentical$`Spanish (European).x` - Eu_Pr_Nonidentical$`Spanish (Peruvian).x`)

dif_Mx_Ar_Identical <- abs(Mx_Ar_Identical$`Spanish (Mexican).x` - Mx_Ar_Identical$`Spanish (Argentinian).x`)
dif_Mx_Ar_NonIdentical <- abs(Mx_Ar_NonIdentical$`Spanish (Mexican).x` - Mx_Ar_NonIdentical$`Spanish (Argentinian).x`)

dif_Mx_Pr_Identical <- abs(Mx_Pr_Identical$`Spanish (Mexican).x` - Mx_Pr_Identical$`Spanish (Peruvian).x`)
dif_Mx_Pr_NonIdentical <- abs(Mx_Pr_NonIdentical$`Spanish (Mexican).x` - Mx_Pr_NonIdentical$`Spanish (Peruvian).x`)

dif_Pr_Ar_Identical <- abs(Pr_Ar_Identical$`Spanish (Peruvian).x` - Pr_Ar_Identical$`Spanish (Argentinian).x`)
dif_Pr_Ar_NonIdentical <- abs(Pr_Ar_NonIdentical$`Spanish (Peruvian).x` - Pr_Ar_NonIdentical$`Spanish (Argentinian).x`)

# Perform a t-test for these differences
t.test(dif_Eu_Mx_Identical, dif_Eu_Mx_NonIdentical)

t.test(dif_Eu_Ar_Identical, dif_Eu_Ar_NonIdentical)

t.test(dif_Eu_Pr_Identical, dif_Eu_Pr_NonIdentical)

t.test(dif_Mx_Ar_Identical, dif_Mx_Ar_NonIdentical)

t.test(dif_Mx_Pr_Identical, dif_Mx_Pr_NonIdentical)

t.test(dif_Pr_Ar_Identical, dif_Pr_Ar_NonIdentical)

# Make a data frame of p-values
